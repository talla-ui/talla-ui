...
export class LazyString extends String {
	 ...
	 * - This method is called automatically when the application I18n provider is changed (see {@link GlobalContext.i18n app.i18n}), so that all (localized) strings are re-evaluated when {@link LazyString.toString toString()} is called again on the same LazyString instance
	 */
	 ...
	 * - This method is called automatically when the application I18n provider is changed (see {@link GlobalContext.i18n app.i18n})
	 */
	 ...
	 * @summary This method calls {@link I18nProvider.format} on the current application I18n provider (see {@link GlobalContext.i18n app.i18n}), with a single value and format type.
	 *
	 ...
	 * - The cache can be reset using {@link LazyString.invalidateCache()}, which is done automatically when changing the application I18n provider (see {@link GlobalContext.i18n app.i18n}).
