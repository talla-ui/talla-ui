 ...
 *
 * If the platform does not support persisted settings, notably the test context, data is cleared each time the global context is initialized (i.e. when calling `useTestContext()`).
 *
