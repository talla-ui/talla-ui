 ...
 * @description
 * A NavigationTarget object can be used to communicate a location that the application can navigate to, along with title text. Objects are typically created from activity instances or URL-like paths, and can be used with {@link UIButton.navigateTo} or directly with {@link AppContext.navigate app.navigate}.
 * @see {@link Activity.getNavigationTarget}
 * @see {@link UIButton.navigateTo}
 * @see {@link AppContext.navigate}
 */
