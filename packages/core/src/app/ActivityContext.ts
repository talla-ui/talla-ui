 ...
 * - An instance of this class is available as {@link AppContext.activities app.activities}.
 * - To add an activity to the context, use the {@link AppContext.addActivity} method. This method also coordinates the activation and deactivation of activities based on the current navigation location.
