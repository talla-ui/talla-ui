 ...
 *
 * The validation mode determines when fields are validated — see {@link FormState.ValidationMode} and {@link FormState.setValidation()}.
 *
...
> extends ObservableObject {
	 ...
	 * @see {@link FormState.ValidationMode}
	 * @readonly
	 */
	 ...
	 * - This property is updated according to the current validation mode — see {@link FormState.ValidationMode}.
	 ...
	 * @summary This method sets a form field to the provided value. The field may also be validated depending on the current validation mode — see {@link FormState.ValidationMode}. If the new value is different from the current value, a change event is emitted on the form state itself, updating all bindings for values and errors.
	 ...
	 * @see {@link FormState.ValidationMode}
	 */
	setValidation(mode: FormState.ValidationMode) {
		this._mode = mode;
		return this;
	}
	...
	private _mode: FormState.ValidationMode = "auto";
}
...
export namespace FormState {
	 ...
	 */
	export type ValidationMode = "demand" | "auto" | "immediate";
}
