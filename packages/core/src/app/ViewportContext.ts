 ...
 *
 * @description
 * A ViewportContext object is available on the global application context, as {@link AppContext.viewport app.viewport}. This instance can be used to customize the UI for different viewport sizes — either directly or through a binding.
 *
