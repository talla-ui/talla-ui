...
import { I18nProvider, LazyString, strf } from "../dist/index.js";

beforeEach(() => {
	LazyString.setI18nInterface(undefined);
	LazyString.setErrorHandler((err) => {
		throw err;
	});
});
...
describe("Set i18n provider with LazyString directly", () => {
