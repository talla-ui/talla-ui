...
function buildTarget(target, entryPoint, alias) {
	...
	if (alias) options.alias = { "desk-frame": alias };
	return Promise.all([
		buildAndCompress({
			format: "esm",
...
await Promise.all([
	...
	buildTarget("es2020", "dist-es2020/index.js", "desk-frame/dist-es2020"),
	buildTarget("es2018", "dist-es2018/index.js", "desk-frame/dist-es2018"),
	buildTarget("es2015", "dist-es2015/index.js", "desk-frame/dist-es2015"),
]);
