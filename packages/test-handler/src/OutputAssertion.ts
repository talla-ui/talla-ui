import { UIContainer, UIElement, View } from "@talla-ui/core";
 ...
 * - An instance of this class is returned by the {@link expectOutputAsync()}, {@link TestRenderer.expectOutput()}, and {@link expectOutputAsync()} methods. Use these methods to create new assertions based on the currently rendered (test) output.
 */
